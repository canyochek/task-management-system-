  ...
  return (
    <>
      ...
      <ul className="user-card__menu">
        <SidebarItem className="user-card__menu-item" text="Upcoming" icon={<img src={chevrons} className="user-card__menu-icon" />}/>
        <SidebarItem className="user-card__menu-item" text="Today" icon={<img src={list} className="user-card__menu-icon" />}/>
